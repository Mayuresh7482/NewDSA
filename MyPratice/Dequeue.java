...
// Java Program to Implement day03.Queue using Array and Generics
...
class queue<T> {
    ...
    void dequeue() {
        ...
        if (this.empty()) // Display message when queue is already empty
        {
            System.out.println("day03.Queue is already empty");
...
class Dequeue {
    ...
    // day03.Main driver method
    public static void main(String[] args) {
        // Case 1 : Integer day03.Queue
